    ...
    >
      ...
      `}>
        ...
        <div className="flex items-center space-x-3">
          {/* Field Type Icon */}
          <div className={`
            p-2.5 rounded-lg bg-gradient-to-r ${getFieldTypeColor(fieldType.type)} text-white shadow-sm
        ...
        <div className="p-6 space-y-4">
          ...
          <div className="bg-white rounded-lg p-4 border border-gray-200">
            ...
            <div className="space-y-2 text-xs text-gray-600">
              ...
              <div className="flex items-start space-x-2">
                ...
                <span>Click the canvas for quick field menu</span>
              </div>
              <div className="flex items-start space-x-2">
                <div className="w-1.5 h-1.5 bg-purple-500 rounded-full mt-1.5"></div>
                <span>Configure fields after adding them</span>
              </div>
              <div className="flex items-start space-x-2">
                <div className="w-1.5 h-1.5 bg-orange-500 rounded-full mt-1.5"></div>
                <span>Reorder fields by dragging in canvas</span>
              </div>
            </div>
          </div>
          ...
          <div className="text-center">
            <div className="text-xs text-gray-500 bg-gray-100 px-3 py-2 rounded-lg inline-flex items-center space-x-2">
              <Zap className="w-3 h-3" />
              <span>Form Builder Studio v2.0</span>
            </div>
          </div>
        </div>
      </footer>
